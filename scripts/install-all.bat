...
%ANDROID%\platform-tools\adb.exe install ../android/fennec-28.0a2.en-US.android-arm.apk
...
%ANDROID%\platform-tools\adb.exe install ../android/SMILETeacher-0.9.9b1.apk
