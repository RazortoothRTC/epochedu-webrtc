"""
	Simple example to install an apk file
...
url1 = 'http://zxing.googlecode.com/files/BarcodeScanner3.53b1.apk'
type1 = 'application/vnd.android.package-archive' # For some reason, this causes a crash, so don't use it
