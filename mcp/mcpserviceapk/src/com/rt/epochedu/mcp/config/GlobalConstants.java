...
package com.rt.epochedu.mcp.config;

public class GlobalConstants {

	public static final String PYTHON_MAIN_SCRIPT_NAME = "mcpservice.py";
	public static final String PYTHON_PROJECT_ZIP_NAME = "mcpservice.zip";
